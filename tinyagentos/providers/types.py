...
class ProviderTypeSpec:
    ...
    def chat_prefix(self) -> str:
        """LiteLLM prefix to use for chat completions (may differ from embedding prefix)."""
        return self.litellm_chat_prefix if self.litellm_chat_prefix else self.litellm_prefix
...
_PROVIDERS: tuple[ProviderTypeSpec, ...] = (
    ...
    ProviderTypeSpec(id="anthropic", category="cloud", label="Anthropic",
        ...
        litellm_prefix="anthropic", adapter_class="CloudAPIAdapter"),
    ProviderTypeSpec(id="openrouter", category="cloud", label="OpenRouter",
        ...
        litellm_prefix="openrouter", adapter_class="CloudAPIAdapter"),
